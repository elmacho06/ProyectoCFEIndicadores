...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta10 AS meta_chenalho, c.tolerancia10 AS tolerancia_chenalho, c.reales10 AS reales_chenalho, 
               o.meta10 AS meta_comalapa, o.tolerancia10 AS tolerancia_comalapa, o.reales10 AS reales_comalapa, 
               b.meta10 AS meta_comitam, b.tolerancia10 AS tolerancia_comitam, b.reales10 AS reales_comitam, 
               d.meta10 AS meta_empleado, d.tolerancia10 AS tolerancia_empleado, d.reales10 AS reales_empleado, 
               e.meta10 AS meta_margaritas, e.tolerancia10 AS tolerancia_margaritas, e.reales10 AS reales_margaritas, 
               f.meta10 AS meta_ocosingo, f.tolerancia10 AS tolerancia_ocosingo, f.reales10 AS reales_ocosingo, 
               g.meta10 AS meta_teopisca, g.tolerancia10 AS tolerancia_teopisca, g.reales10 AS reales_teopisca, 
               h.meta10 AS meta_vcarranza, h.tolerancia10 AS tolerancia_vcarranza, h.reales10 AS reales_vcarranza, 
               i.meta10 AS meta_yajalon, i.tolerancia10 AS tolerancia_yajalon, i.reales10 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Noviembre Por Agencias"</h2>
    ...
    <button onclick="exportToExcel('Noviembre')" style="
    display: block; 
    margin: 20px auto; 
    padding: 10px 20px; 
    font-size: 16px; 
...
">Generar Excel Noviembre</button>
