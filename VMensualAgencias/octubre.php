...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta9 AS meta_chenalho, c.tolerancia9 AS tolerancia_chenalho, c.reales9 AS reales_chenalho, 
               o.meta9 AS meta_comalapa, o.tolerancia9 AS tolerancia_comalapa, o.reales9 AS reales_comalapa, 
               b.meta9 AS meta_comitam, b.tolerancia9 AS tolerancia_comitam, b.reales9 AS reales_comitam, 
               d.meta9 AS meta_empleado, d.tolerancia9 AS tolerancia_empleado, d.reales9 AS reales_empleado, 
               e.meta9 AS meta_margaritas, e.tolerancia9 AS tolerancia_margaritas, e.reales9 AS reales_margaritas, 
               f.meta9 AS meta_ocosingo, f.tolerancia9 AS tolerancia_ocosingo, f.reales9 AS reales_ocosingo, 
               g.meta9 AS meta_teopisca, g.tolerancia9 AS tolerancia_teopisca, g.reales9 AS reales_teopisca, 
               h.meta9 AS meta_vcarranza, h.tolerancia9 AS tolerancia_vcarranza, h.reales9 AS reales_vcarranza, 
               i.meta9 AS meta_yajalon, i.tolerancia9 AS tolerancia_yajalon, i.reales9 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Octubre Por Agencias"</h2>
    ...
    <button onclick="exportToExcel('Octubre')" style="
    display: block; 
    margin: 20px auto; 
    padding: 10px 20px; 
    font-size: 16px; 
