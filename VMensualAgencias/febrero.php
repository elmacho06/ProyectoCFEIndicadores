...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta1 AS meta_chenalho, c.tolerancia1 AS tolerancia_chenalho, c.reales1 AS reales_chenalho, 
               o.meta1 AS meta_comalapa, o.tolerancia1 AS tolerancia_comalapa, o.reales1 AS reales_comalapa, 
               b.meta1 AS meta_comitam, b.tolerancia1 AS tolerancia_comitam, b.reales1 AS reales_comitam, 
               d.meta1 AS meta_empleado, d.tolerancia1 AS tolerancia_empleado, d.reales1 AS reales_empleado, 
               e.meta1 AS meta_margaritas, e.tolerancia1 AS tolerancia_margaritas, e.reales1 AS reales_margaritas, 
               f.meta1 AS meta_ocosingo, f.tolerancia1 AS tolerancia_ocosingo, f.reales1 AS reales_ocosingo, 
               g.meta1 AS meta_teopisca, g.tolerancia1 AS tolerancia_teopisca, g.reales1 AS reales_teopisca, 
               h.meta1 AS meta_vcarranza, h.tolerancia1 AS tolerancia_vcarranza, h.reales1 AS reales_vcarranza, 
               i.meta1 AS meta_yajalon, i.tolerancia1 AS tolerancia_yajalon, i.reales1 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Febrero Por Agencias"</h2>
    ...
    <button onclick="exportToExcel('Febrero')" style="
    display: block; 
    margin: 20px auto; 
    padding: 10px 20px; 
    font-size: 16px; 
