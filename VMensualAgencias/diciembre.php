...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta11 AS meta_chenalho, c.tolerancia11 AS tolerancia_chenalho, c.reales11 AS reales_chenalho, 
               o.meta11 AS meta_comalapa, o.tolerancia11 AS tolerancia_comalapa, o.reales11 AS reales_comalapa, 
               b.meta11 AS meta_comitam, b.tolerancia11 AS tolerancia_comitam, b.reales11 AS reales_comitam, 
               d.meta11 AS meta_empleado, d.tolerancia11 AS tolerancia_empleado, d.reales11 AS reales_empleado, 
               e.meta11 AS meta_margaritas, e.tolerancia11 AS tolerancia_margaritas, e.reales11 AS reales_margaritas, 
               f.meta11 AS meta_ocosingo, f.tolerancia11 AS tolerancia_ocosingo, f.reales11 AS reales_ocosingo, 
               g.meta11 AS meta_teopisca, g.tolerancia11 AS tolerancia_teopisca, g.reales11 AS reales_teopisca, 
               h.meta11 AS meta_vcarranza, h.tolerancia11 AS tolerancia_vcarranza, h.reales11 AS reales_vcarranza, 
               i.meta11 AS meta_yajalon, i.tolerancia11 AS tolerancia_yajalon, i.reales11 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Diciembre Por Agencias"</h2>
    ...
    <button onclick="exportToExcel('Diciembre')" style="
    display: block; 
    margin: 20px auto; 
    padding: 10px 20px; 
    font-size: 16px; 
...
">Generar Excel Diciembre</button>
