...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta6 AS meta_chenalho, c.tolerancia6 AS tolerancia_chenalho, c.reales6 AS reales_chenalho, 
               o.meta6 AS meta_comalapa, o.tolerancia6 AS tolerancia_comalapa, o.reales6 AS reales_comalapa, 
               b.meta6 AS meta_comitam, b.tolerancia6 AS tolerancia_comitam, b.reales6 AS reales_comitam, 
               d.meta6 AS meta_empleado, d.tolerancia6 AS tolerancia_empleado, d.reales6 AS reales_empleado, 
               e.meta6 AS meta_margaritas, e.tolerancia6 AS tolerancia_margaritas, e.reales6 AS reales_margaritas, 
               f.meta6 AS meta_ocosingo, f.tolerancia6 AS tolerancia_ocosingo, f.reales6 AS reales_ocosingo, 
               g.meta6 AS meta_teopisca, g.tolerancia6 AS tolerancia_teopisca, g.reales6 AS reales_teopisca, 
               h.meta6 AS meta_vcarranza, h.tolerancia6 AS tolerancia_vcarranza, h.reales6 AS reales_vcarranza, 
               i.meta6 AS meta_yajalon, i.tolerancia6 AS tolerancia_yajalon, i.reales6 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Julio Por Agencias"</h2>
    ...
    <button onclick="exportToExcel('Julio')" style="
    display: block; 
    margin: 20px auto; 
    padding: 10px 20px; 
    font-size: 16px; 
