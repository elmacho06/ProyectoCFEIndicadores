...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta3 AS meta_chenalho, c.tolerancia3 AS tolerancia_chenalho, c.reales3 AS reales_chenalho, 
               o.meta3 AS meta_comalapa, o.tolerancia3 AS tolerancia_comalapa, o.reales3 AS reales_comalapa, 
               b.meta3 AS meta_comitam, b.tolerancia3 AS tolerancia_comitam, b.reales3 AS reales_comitam, 
               d.meta3 AS meta_empleado, d.tolerancia3 AS tolerancia_empleado, d.reales3 AS reales_empleado, 
               e.meta3 AS meta_margaritas, e.tolerancia3 AS tolerancia_margaritas, e.reales3 AS reales_margaritas, 
               f.meta3 AS meta_ocosingo, f.tolerancia3 AS tolerancia_ocosingo, f.reales3 AS reales_ocosingo, 
               g.meta3 AS meta_teopisca, g.tolerancia3 AS tolerancia_teopisca, g.reales3 AS reales_teopisca, 
               h.meta3 AS meta_vcarranza, h.tolerancia3 AS tolerancia_vcarranza, h.reales3 AS reales_vcarranza, 
               i.meta3 AS meta_yajalon, i.tolerancia3 AS tolerancia_yajalon, i.reales3 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Abril Por Agencias"</h2>
    ...
    <button onclick="exportToExcel('Abril')" style="
    display: block; 
    margin: 20px auto; 
    padding: 10px 20px; 
    font-size: 16px; 
