...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta8 AS meta_chenalho, c.tolerancia8 AS tolerancia_chenalho, c.reales8 AS reales_chenalho, 
               o.meta8 AS meta_comalapa, o.tolerancia8 AS tolerancia_comalapa, o.reales8 AS reales_comalapa, 
               b.meta8 AS meta_comitam, b.tolerancia8 AS tolerancia_comitam, b.reales8 AS reales_comitam, 
               d.meta8 AS meta_empleado, d.tolerancia8 AS tolerancia_empleado, d.reales8 AS reales_empleado, 
               e.meta8 AS meta_margaritas, e.tolerancia8 AS tolerancia_margaritas, e.reales8 AS reales_margaritas, 
               f.meta8 AS meta_ocosingo, f.tolerancia8 AS tolerancia_ocosingo, f.reales8 AS reales_ocosingo, 
               g.meta8 AS meta_teopisca, g.tolerancia8 AS tolerancia_teopisca, g.reales8 AS reales_teopisca, 
               h.meta8 AS meta_vcarranza, h.tolerancia8 AS tolerancia_vcarranza, h.reales8 AS reales_vcarranza, 
               i.meta8 AS meta_yajalon, i.tolerancia8 AS tolerancia_yajalon, i.reales8 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Septiembre Por Agencias"</h2>
    ...
    <button onclick="exportToExcel('septiembre')" style="
    display: block; 
    margin: 20px auto; 
    padding: 10px 20px; 
    font-size: 16px; 
...
">Generar Excel Septiembre</button>
