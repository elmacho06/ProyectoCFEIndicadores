...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta2 AS meta_chenalho, c.tolerancia2 AS tolerancia_chenalho, c.reales2 AS reales_chenalho, 
               o.meta2 AS meta_comalapa, o.tolerancia2 AS tolerancia_comalapa, o.reales2 AS reales_comalapa, 
               b.meta2 AS meta_comitam, b.tolerancia2 AS tolerancia_comitam, b.reales2 AS reales_comitam, 
               d.meta2 AS meta_empleado, d.tolerancia2 AS tolerancia_empleado, d.reales2 AS reales_empleado, 
               e.meta2 AS meta_margaritas, e.tolerancia2 AS tolerancia_margaritas, e.reales2 AS reales_margaritas, 
               f.meta2 AS meta_ocosingo, f.tolerancia2 AS tolerancia_ocosingo, f.reales2 AS reales_ocosingo, 
               g.meta2 AS meta_teopisca, g.tolerancia2 AS tolerancia_teopisca, g.reales2 AS reales_teopisca, 
               h.meta2 AS meta_vcarranza, h.tolerancia2 AS tolerancia_vcarranza, h.reales2 AS reales_vcarranza, 
               i.meta2 AS meta_yajalon, i.tolerancia2 AS tolerancia_yajalon, i.reales2 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Marzo Por Agencias"</h2>
