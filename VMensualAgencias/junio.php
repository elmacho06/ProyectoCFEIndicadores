...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta5 AS meta_chenalho, c.tolerancia5 AS tolerancia_chenalho, c.reales5 AS reales_chenalho, 
               o.meta5 AS meta_comalapa, o.tolerancia5 AS tolerancia_comalapa, o.reales5 AS reales_comalapa, 
               b.meta5 AS meta_comitam, b.tolerancia5 AS tolerancia_comitam, b.reales5 AS reales_comitam, 
               d.meta5 AS meta_empleado, d.tolerancia5 AS tolerancia_empleado, d.reales5 AS reales_empleado, 
               e.meta5 AS meta_margaritas, e.tolerancia5 AS tolerancia_margaritas, e.reales5 AS reales_margaritas, 
               f.meta5 AS meta_ocosingo, f.tolerancia5 AS tolerancia_ocosingo, f.reales5 AS reales_ocosingo, 
               g.meta5 AS meta_teopisca, g.tolerancia5 AS tolerancia_teopisca, g.reales5 AS reales_teopisca, 
               h.meta5 AS meta_vcarranza, h.tolerancia5 AS tolerancia_vcarranza, h.reales5 AS reales_vcarranza, 
               i.meta5 AS meta_yajalon, i.tolerancia5 AS tolerancia_yajalon, i.reales5 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Junio Por Agencias"</h2>
    ...
    <button onclick="exportToExcel('Junio')" style="
    display: block; 
    margin: 20px auto; 
    padding: 10px 20px; 
    font-size: 16px; 
