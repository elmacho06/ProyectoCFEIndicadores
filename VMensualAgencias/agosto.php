...
$sql = "SELECT a.indice, a.meta, a.tolerancia, a.reales, 
               c.meta7 AS meta_chenalho, c.tolerancia7 AS tolerancia_chenalho, c.reales7 AS reales_chenalho, 
               o.meta7 AS meta_comalapa, o.tolerancia7 AS tolerancia_comalapa, o.reales7 AS reales_comalapa, 
               b.meta7 AS meta_comitam, b.tolerancia7 AS tolerancia_comitam, b.reales7 AS reales_comitam, 
               d.meta7 AS meta_empleado, d.tolerancia7 AS tolerancia_empleado, d.reales7 AS reales_empleado, 
               e.meta7 AS meta_margaritas, e.tolerancia7 AS tolerancia_margaritas, e.reales7 AS reales_margaritas, 
               f.meta7 AS meta_ocosingo, f.tolerancia7 AS tolerancia_ocosingo, f.reales7 AS reales_ocosingo, 
               g.meta7 AS meta_teopisca, g.tolerancia7 AS tolerancia_teopisca, g.reales7 AS reales_teopisca, 
               h.meta7 AS meta_vcarranza, h.tolerancia7 AS tolerancia_vcarranza, h.reales7 AS reales_vcarranza, 
               i.meta7 AS meta_yajalon, i.tolerancia7 AS tolerancia_yajalon, i.reales7 AS reales_yajalon
        FROM acala a 
...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">"Valores De Agosto Por Agencias"</h2>
    ...
    <button onclick="exportToExcel('Agosto')" style="
    display: block; 
    margin: 20px auto; 
    padding: 10px 20px; 
    font-size: 16px; 
