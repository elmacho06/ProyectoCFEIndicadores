...
$sql = "UPDATE chenalho SET $campo = ? WHERE indice = ?";
...
foreach ($ids as $id) {
    $sql_meta = "SELECT meta, meta1, meta2, meta3, meta4, meta5, meta6, meta7, meta8, meta9, meta10, meta11 FROM chenalho WHERE id = ?";
    ...
    if ($resultado_meta->num_rows > 0) {
        ...
        $sql_actualizacion = "UPDATE chenalho SET tolerancia = ?, tolerancia1 = ?, tolerancia2 = ?, tolerancia3 = ?, tolerancia4 = ?, tolerancia5 = ?, tolerancia6 = ?, tolerancia7 = ?, tolerancia8 = ?, tolerancia9 = ?, tolerancia10 = ?, tolerancia11 = ? WHERE id = ?";
...
$sql_meta3 = "SELECT meta, meta1, meta2, meta3, meta4, meta5, meta6, meta7, meta8, meta9, meta10, meta11 FROM chenalho WHERE id = 3";
...
if ($resultado_meta3->num_rows > 0) {
    ...
    $sql_actualizacion_id3 = "UPDATE chenalho SET tolerancia = ?, tolerancia1 = ?, tolerancia2 = ?, tolerancia3 = ?, tolerancia4 = ?, tolerancia5 = ?, tolerancia6 = ?, tolerancia7 = ?, tolerancia8 = ?, tolerancia9 = ?, tolerancia10 = ?, tolerancia11 = ? WHERE id = 3";
...
$sql_meta = "SELECT meta, meta1, meta2, meta3, meta4, meta5, meta6, meta7, meta8, meta9, meta10, meta11 FROM chenalho WHERE id = 4";
...
if ($resultado_meta->num_rows > 0) {
    ...
    $sql_actualizacion = "UPDATE chenalho SET tolerancia = ?, tolerancia1 = ?, tolerancia2 = ?, tolerancia3 = ?, tolerancia4 = ?, tolerancia5 = ?, tolerancia6 = ?, tolerancia7 = ?, tolerancia8 = ?, tolerancia9 = ?, tolerancia10 = ?, tolerancia11 = ? WHERE id = 4";
    $stmt_tolerancia = $conn->prepare($sql_actualizacion);
...
//------------------------------------------------------registro 10(+10%)---------------------------------------------------------------
$sql_meta10 = "SELECT meta, meta1, meta2, meta3, meta4, meta5, meta6, meta7, meta8, meta9, meta10, meta11 FROM chenalho WHERE id = 10";
...
if ($resultado_meta10->num_rows > 0) {
    ...
    $sql_actualizacion_id10 = "UPDATE chenalho SET tolerancia = ?, tolerancia1 = ?, tolerancia2 = ?, tolerancia3 = ?, tolerancia4 = ?, tolerancia5 = ?, tolerancia6 = ?, tolerancia7 = ?, tolerancia8 = ?, tolerancia9 = ?, tolerancia10 = ?, tolerancia11 = ? WHERE id = 10";
