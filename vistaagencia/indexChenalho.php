...
if ($result->num_rows > 0) {
    ...
    $cellColor = '';
		...
		$cellColor = 'highlight-red'; 
		$RedFlagCliente++;
		} elseif ($real1 = $tolerancia && $real <= $meta) {
		$cellColor = 'highlight-yellow'; // Amarillo si está entre la tolerancia y la meta
		}
...
// SALIDAS DE VALIDACION SI - NO
	...
	*/
    ...
    $('td[contenteditable="true"]').blur(function(){
        ...
        $.ajax({
            url: '../conexion/updateChenalho.php',
            method: 'POST',
...
// Título
echo "<h2 style='text-align: center;'>ACUMULADO VALORES MENSUALES AGENCIA CHENALHO</h2>";
