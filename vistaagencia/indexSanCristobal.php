...
<body>
    <div style="background-color: green; color: white; padding: 10px; text-align: center;">
        <h2 style="margin: 0;">INDICE DE CONTRATO PROGRAMA ZONA SAN CRISTOBAL</h2>
...
// Título
echo "<h2 style='text-align: center;'>ACUMULADO VALORES MENSUALES AGENCIA SAN CRISTOBAL DE LAS CASAS</h2>";
