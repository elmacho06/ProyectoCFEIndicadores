...
if (isset($_GET['month'])) {
    ...
    if ($month === 'enero') {
        $sql = "SELECT indice, meta, tolerancia, reales FROM acala LIMIT 12";
    } elseif ($month === 'febrero') {
        $sql = "SELECT indice, meta1 AS meta, tolerancia1 AS tolerancia, reales1 AS reales FROM acala LIMIT 12";
    } elseif ($month === 'marzo') {
...
<body>
    <div class="navbar">
        ...
        <select id="pageSelect">
            ...
            <option value="../vistaagencia/indexAcala.php">Página Acala</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=enero">Enero</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=febrero">Febrero</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=marzo">Marzo</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=abril">Abril</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=mayo">Mayo</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=junio">Junio</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=julio">Julio</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=agosto">Agosto</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=septiembre">Septiembre</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=octubre">Octubre</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=noviembre">Noviembre</option>
            <option value="../VMensualAcala/consulta_mensual.php?month=diciembre">Diciembre</option>
        </select>
        ...
        <h1>"Transparencia y Eficiencia: Seguimiento de Indicadores en acala"</h1>
        <button><a href="../vistaagencia/indexAcala.php">Subir Avances</a></button> 
    ...
    <script>
        ...
        chartButton.addEventListener('click', function() {
            loadPage('../graficos_agencias_mensuales/consultar_datos_acala.php'); // Cargar contenido de enero.php
        });
