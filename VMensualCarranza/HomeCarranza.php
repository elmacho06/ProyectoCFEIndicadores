...
<body>
    <div class="navbar">
        ...
        <select id="pageSelect">
            ...
            <option value="../vistaagencia/indexCarranza.php">Página Carranza</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=enero">Enero</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=febrero">Febrero</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=marzo">Marzo</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=abril">Abril</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=mayo">Mayo</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=junio">Junio</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=julio">Julio</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=agosto">Agosto</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=septiembre">Septiembre</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=octubre">Octubre</option>
            <option value="../VMensualCarranza/consulta_mensual.php?month=noviembre">Noviembre</option>
        ...
        <h2 id="title">Transparencia y Eficiencia: Seguimiento de Indicadores en V. Carranza</h2>
  ...
  max-width: 1600px; /* Controla el ancho máximo del contenido */
    ...
    <script>
        ...
        chartButton.addEventListener('click', function() {
            loadPage('../graficos_agencias_mensuales/consultar_datos_carranza.php'); // Cargar contenido de enero.php
        });
