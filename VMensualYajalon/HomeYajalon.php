...
if (isset($_GET['month'])) {
    ...
    if ($month === 'enero') {
        $sql = "SELECT indice, meta, tolerancia, reales FROM yajalon LIMIT 12";
    } elseif ($month === 'febrero') {
        $sql = "SELECT indice, meta1 AS meta, tolerancia1 AS tolerancia, reales1 AS reales FROM yajalon LIMIT 12";
    } elseif ($month === 'marzo') {
        $sql = "SELECT indice, meta2 AS meta, tolerancia2 AS tolerancia, reales2 AS reales FROM yajalon LIMIT 12";
    } elseif ($month === 'abril') {
        $sql = "SELECT indice, meta3 AS meta, tolerancia3 AS tolerancia, reales3 AS reales FROM yajalon LIMIT 12";
    } elseif ($month === 'mayo') {
        $sql = "SELECT indice, meta4 AS meta, tolerancia4 AS tolerancia, reales4 AS reales FROM yajalon LIMIT 12";
    } elseif ($month === 'junio') {
        $sql = "SELECT indice, meta5 AS meta, tolerancia5 AS tolerancia, reales5 AS reales FROM yajalon LIMIT 12";
    } elseif ($month === 'julio') {
        $sql = "SELECT indice, meta6 AS meta, tolerancia6 AS tolerancia, reales6 AS reales FROM yajalon LIMIT 12";
    } elseif ($month === 'agosto') {
        $sql = "SELECT indice, meta7 AS meta, tolerancia7 AS tolerancia, reales7 AS reales FROM yajalon LIMIT 12";
    } elseif ($month === 'septiembre') {
        $sql = "SELECT indice, meta8 AS meta, tolerancia8 AS tolerancia, reales8 AS reales FROM yajalon LIMIT 12";
    } elseif ($month === 'octubre') {
        $sql = "SELECT indice, meta9 AS meta, tolerancia9 AS tolerancia, reales9 AS reales FROM yajalon LIMIT 12";
    } elseif ($month === 'noviembre') {
        $sql = "SELECT indice, meta10 AS meta, tolerancia10 AS tolerancia, reales10 AS reales FROM yajalon LIMIT 12";
    } 
    elseif ($month === 'diciembre') {
        $sql = "SELECT indice, meta11 AS meta, tolerancia11 AS tolerancia, reales11 AS reales FROM yajalon LIMIT 12";
    } 
...
<body>
    <div class="navbar">
        ...
        <select id="pageSelect">
            ...
            <option value="../vistaagencia/indexYajalon.php">Página Yajalon</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=enero">Enero</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=febrero">Febrero</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=marzo">Marzo</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=abril">Abril</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=mayo">Mayo</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=junio">Junio</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=julio">Julio</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=agosto">Agosto</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=septiembre">Septiembre</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=octubre">Octubre</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=noviembre">Noviembre</option>
            <option value="../VMensualYajalon/consulta_mensual_yajalon.php?month=diciembre">Diciembre</option>
        </select>
        ...
        <h1>"Transparencia y Eficiencia: Seguimiento de Indicadores en Yajalon"</h1>
        <button><a href="../vistaagencia/indexYajalon.php">Subir Avances</a></button> 
  ...
  max-width: 1600px; /* Controla el ancho máximo del contenido */
    ...
    <script>
        ...
        chartButton.addEventListener('click', function() {
            loadPage('../graficos_agencias_mensuales/consultar_datos_yajalon.php'); // Cargar contenido de enero.php
        });
